...
public class FireBall : MonoBehaviour {
    ...
    {
        Debug.Log("collision fireball and cookie or something else");
        CookieController.singleton.transform.parent.position = CookieController.singleton.initialPosition;
